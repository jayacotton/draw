...
/* * FLAG THE OLD VIRTUAL COORDINATES AS INCORRECT */
    tktrnx_1.kgrafl = 0;
    pidv2 = 90.f;
/* * SET UP UNTRANSLATED TRIAL POLAR WINDOW       */
    tktrnx_1.trpar3 = 0.f;
    tktrnx_1.trpar4 = 0.f;
    tktrnx_1.trfacy = 1.f;
    tktrnx_1.trpar6 = 0.f;
...
/* * FIND EXTREMES OF THE TRIAL POLAR WINDOW      */
...
/* Computing MAX */
    ...
    nquad = 0;
/* * CHECK EXTREMES OF TRIAL WINDOW AT 90 DEGREE INTERVALS */
  L200:
    if (quad >= thmax) {
	goto L300;
    }
...
/* * COMPUTE SCREEN AND VIRTUAL RANGES                   */
  L300:
